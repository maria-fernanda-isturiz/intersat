    ...
    @section('contenido-dinamico')
        <div class="card mt-4 mx-4">
            <div class="d-flex justify-content-between">
                <h4 class="card-header">Listado de Equipos</h4>
                <div class="mt-3 pt-3 px-4">
                    <a href="{{route('register_equipments')}}"><i class="bx bxs-book-add"></i> Agregar</a>
                </div>
            </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <input type="hidden" name="id_equipment" value="{{$equipment->id}}">
                  <div class="mb-3">
                    <label for="" class="form-label">¿Desea eliminar el equipo y dejar el dispositivo fuera de servicio?</label>
